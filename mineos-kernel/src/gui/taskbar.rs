...
// MineOS - Taskbar (Rust)
// =============================================================================
// The bottom taskbar with start button, running apps, and system tray.
// =============================================================================
...
impl Taskbar {
    ...
    pub fn draw(&self, fb: &mut FrameBuffer, wm: &WindowManager) {
        ...
        // Start button (hexagon icon approximation)
        ...
        // Draw a simple hexagon shape for start button
    ...
    fn draw_hexagon(&self, fb: &mut FrameBuffer, cx: usize, cy: usize, r: usize, color: Color) {
        ...
        for i in 0..6 {
            ...
            self.draw_line(fb,
                (cx as isize + x1) as usize,
                (cy as isize + y1) as usize,
                (cx as isize + x2) as usize,
                (cy as isize + y2) as usize,
                color,
            );
        }
    }
    ...
    fn draw_wifi_icon(&self, fb: &mut FrameBuffer, x: usize, y: usize) {
        // Three arcs (simplified as horizontal lines)
