...
// =============================================================================
// A bare-metal operating system kernel written in Rust with no standard library.
// =============================================================================
...
fn kernel_main(boot_info: &'static BootInfo) -> ! {
    ...
    drivers::vga_text::print_str("(GUI desktop: use 'startx' command)\n\n");
...
fn panic(info: &PanicInfo) -> ! {
    drivers::vga_text::set_color(0x04);
